...
) else if "%TARGET_NAME%"=="mcg2" (
	set TARGET_NAME_FALLBACK=nrtos
) else (
	set TARGET_NAME_FALLBACK=nrtos4
)
...
%GB_COMP_REPOSITORY%\tds-com\%TDSCOMVERSION%\dlu\%TARGET_NAME%\0000-tds_com_%DEVTYPE%.dl2,^
%GB_COMP_REPOSITORY%\tds-tcl\%TDSTCLVERSION%\dlu\%TARGET_NAME%\0000-tds_tcl_%DEVTYPE%.dl2,^
%GB_COMP_REPOSITORY%\tssp-ip\%TSSPIPVERSION%\dlu\%TARGET_NAME%\0000-tssp_client_%DEVTYPE%.dl2,^
%GB_COMP_REPOSITORY%\vrs-ip\%VRSIPVERSION%\dlu\%TARGET_NAME%\0000-vrs_reporthw1_%DEVTYPE%.dl2,^
%GB_COMP_REPOSITORY%\vrs-ip\%VRSIPVERSION%\dlu\%TARGET_NAME%\0000-vrs_reporthw2_%DEVTYPE%.dl2,^
%GB_COMP_REPOSITORY%\vrs-ip\%VRSIPVERSION%\dlu\%TARGET_NAME%\0000-vrs_client_%DEVTYPE%.dl2,^
%GB_COMP_REPOSITORY%\vrs-ip\%VRSIPVERSION%\dlu\%TARGET_NAME%\0000-vrs_reportsw1_%DEVTYPE%.dl2,^
%GB_COMP_REPOSITORY%\vrs-ip\%VRSIPVERSION%\dlu\%TARGET_NAME%\0000-vrs_reportsw2_%DEVTYPE%.dl2,^
%GB_COMP_REPOSITORY%\vrs-ip\%VRSIPVERSION%\dlu\%TARGET_NAME%\0000-vrs_server_%DEVTYPE%.dl2,^
%GB_COMP_REPOSITORY%\qt-build\%QTBUILDVERSION%\dlu\%TARGET_NAME%\0000-qt_%DEVTYPE%.dl2,^
